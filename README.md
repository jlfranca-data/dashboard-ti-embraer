...
📚 Contexto Acadêmico
Este projeto foi desenvolvido como parte do portfólio acadêmico durante a graduação em Ciência de Dados pela Univesp, demonstrando aplicação prática de:
